// The adapter manages the display of all the budgets
// in a scrollable manner in recyclerview by binding each budgets data into rows.
// This adapter also manages the colors indicating
// the progress of the budgets, status messages and on click behaviors
