// This class helps create and update the pie chart that shows how the total
// spending is broken down into different categories.
// It calculates the percentage of each expense and
// how it contributes to total spending while updating the chart with new data.
